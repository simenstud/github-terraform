...
variable "sa_backend_name" {
    type = string
    description = "Name for the storage account for the backend"
}

variable "sc_backend_name" {
    type = string
    description = "Name for the storage container for the backend"
}

variable "kv_backend_name" {
    type = string
    description = "Name for the key vault for the backend"
}
